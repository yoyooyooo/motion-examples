  ...
  return (
    <div className="relative flex w-full h-full items-center transition-colors duration-500">
      <motion.button
        ...
        className={cn(
          `h-[20px] max-w-[40px]`, // 轮廓宽高
          "relative flex items-center w-full aspect-[2/1] border rounded-full cursor-pointer transition-colors duration-300 shadow-sm outline-none focus-visible:outline-none focus-visible:ring-1",
          "bg-white",
          isDarkMode
            ? "bg-indigo-950 border-transparent"
        ...
        style={
          isDarkMode
            ? {
                boxShadow:
                  "0 0 15px rgba(255, 255, 255, 0.1), inset 0 0 15px rgba(255, 255, 255, 0.1)",
              }
            : {}
        }
      >
        {/* Moving circle / Moon */}
        <motion.div
          className={`w-[16px] h-[16px] bg-white relative flex items-center justify-center rounded-full shadow-md z-20`}
          animate={{ x: isDarkMode ? `calc(${width} - 16px - ${px})` : px }}
            ...
            <div className="w-full h-full flex items-center justify-center rounded-full relative overflow-hidden pl-[3px] pb-[2px]">
              ...
              <div
                ...
                style={{
                  ...
                  // right: "5%",
                  background:
                    "radial-gradient(circle at 70% 70%, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0) 50%)",
                }}
              />
